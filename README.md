...
## Final PR note
This README reflects the final submission-ready checklist and intentionally excludes newcomer-handoff docs to avoid merge conflicts with prior documentation-only branches.
